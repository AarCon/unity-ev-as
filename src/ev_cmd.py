...
class EvCmdType(IntEnum):
    ...
    _GET_BP = auto()
    _FOV_OFFSET_RATE = auto()
    _OBJ_DIR_CHANGE_WORLD = auto()
    _OBJ_POS_CHANGE_WORLD_FIND = auto()
    _ZONE_NAME2 = auto()
    ...
    _GET_RECORD_TOWOR_WIN = auto()
    _TEMOTI_PER_RND = auto()
    _ADD_BTLTWR_CHALLENGE = auto()
    _CHECK_GMS_ONLINE_ACCOUNT = auto()
    _BTLTWR_CONTINUE_ROUND = auto()
    _GMS_END = auto()
    _CMD_NAME_END = auto()